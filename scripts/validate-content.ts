...
function assertUniqueIds(collectionName: string, ids: string[]) {
...
function assertKnownIds(label: string, ids: string[], knownIds: Set<string>) {
...
function assertNoAmbiguousNames(label: string, text: string) {
...
function assertQuoteCharCount(label: string, text: string, expectedCharCount: number) {
...
function main() {
  ...
  const pathStepToPathId = new Map<string, string>();
